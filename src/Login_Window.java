...
public class Login_Window extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String name=jTextField2.getText();
			...
			if(name.equals("nizaretmohamed")&&password.equals("nizarmohamed123")){
                            this.setVisible(false);
         new MainMenuUI().setVisible(true);
				
			}else{
            JOptionPane.showMessageDialog(this, "error de connection ", "Invalid login", JOptionPane.ERROR_MESSAGE);
			}
